...
export const AddNoteUser = () => {
  ...
  return (
    <div className="max-w-8xl mx-auto p-6 bg-white shadow-md rounded-md mt-10">
      ...
      <div className={`mb-4 ${ticket.status == "Closed"? "bg-gray-200 cursor-not-allowed":""} border-[1.6px] border-zinc-300 px-2 py-6 rounded shadow relative`}>
              ...
              <div key={index} className='flex flex-col justify-center pt-2'>
                {
                  note.authorRole ? <div className="flex">
                    ...
                    <h1> {note?.authorRole == "Agent" ? "Agent": note?.authorRole == "Customer" ? "Customer":"Admin"} </h1>
                  </div> : null
                }
                ...
                <img className='mt-3 w-[25%] h-[25%] ' src={note?.attachment} alt="" />
